...
contract YIELDS is ERC20Permit, Ownable {
    ...
    constructor() ERC20("RewardsDAO YIELDS", "YIELDS", 9) ERC20Permit() {
    ...
    /**
        @notice increases YIELDs supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess YIELDs
